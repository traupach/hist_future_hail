...
region.
\item The simulations project increases in hail frequency in the Sydney/Canberra
and Brisbane regions, as well as increases in maximum hail size around
Melbourne, Sydney/Canberra, the Goldfields, and Perth and reductions in
hail-coincident wind strength around Melbourne, Sydney/Canberra, and Perth.
\end{keypoints}
...
daily maxima, to obtain a good fit to distribution tails. For wind speeds which
...
analysis code and WRF configuration files are available Zenodo repository (DOI:
10.5281/zenodo.14607614). Convective parameters were calculated using
\texttt{xarray\_parcel} (DOI: 10.5281/zenodo.8088497). Shapefiles for urban area
